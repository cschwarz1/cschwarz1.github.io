...
draft: false
description: In this blog post of the kernel driver exploitation series we will have a look at a very common vulnerable memory mapping function in the Windows kernel dubbed MmMapIoSpace. 
---
...
The driver employs IOCTL code `0x8000649c` to perform the mapping of physical memory to virtual address space using the `MmMapIoSpace`.
